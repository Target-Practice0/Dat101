...
export class TGameBoard extends TSprite {
  ...
  constructor(aSpcvs, aSPI) {
    ...
    this.#colorButtons = [new TColorButton(aSpcvs, aSPI.ButtonRed, center), new TColorButton(aSpcvs, aSPI.ButtonBlue, center), new TColorButton(aSpcvs, aSPI.ButtonGreen, center), new TColorButton(aSpcvs, aSPI.ButtonYellow, center)];
    ...
    this.spRound.value = round;
    this.#spFinalScore = new TSpriteNumber(aSpcvs, aSPI.number, 370, 450);
    this.#spFinalScore.justify = ESpriteNumberJustifyType.Right;
  }
  ...
  draw() {
    ...
    this.spRound.draw();
    this.#gameInfo.draw();
    if (EGameStatusType.state === EGameStatusType.GameOver) {
